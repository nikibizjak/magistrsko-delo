...
Pri ročnem upravljanju pomnilnika kot ga poznamo npr. pri programskem jeziku C, pride pogosto do dveh vrst napak: uporaba po sproščanju (angl. use-after-free), pri kateri skuša programer dostopati do pomnilniškega naslova, ki je bil že prej sproščen in dvojno sproščanje, pri katerem .

% Kaj je double free ali use after free
% RustBelt, Polonius
...
\begin{figure}[h]
	...
	\end{tikzpicture}
	\caption{Implementacija lastništva in izposoje STG jeziku}
